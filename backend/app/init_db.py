...
def seed_data():
    ...
    try:
        ...
        demo_businesses = [
            {"name": "Tel Aviv Butcher Co.", "store_type": "butcher_shop", "city": "Tel Aviv", "industry": "Food & Beverage", "size": "medium"},
            {"name": "Jerusalem Meats", "store_type": "butcher_shop", "city": "Jerusalem", "industry": "Food & Beverage", "size": "small"},
            {"name": "Haifa Fresh Cuts", "store_type": "butcher_shop", "city": "Haifa", "industry": "Food & Beverage", "size": "small"},
            {"name": "Galilee Vineyards", "store_type": "winery", "city": "Tiberias", "industry": "Agriculture & Wine", "size": "large"},
            {"name": "Negev Winery", "store_type": "winery", "city": "Beer Sheva", "industry": "Agriculture & Wine", "size": "medium"},
            {"name": "Golan Heights Estate", "store_type": "winery", "city": "Haifa", "industry": "Agriculture & Wine", "size": "large"},
        ]
